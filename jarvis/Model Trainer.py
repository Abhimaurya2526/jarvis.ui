...
path = 'jarvis\sample' # Path for samples already taken

recognizer = cv2.face.LBPHFaceRecognizer_create() # Local Binary Patterns Histograms
detector = cv2.CascadeClassifier("jarvis\haarcascade_frontalface_default.xml")
...
recognizer.write('jarvis/trainer/trainer.yml')  # Save the trained model as trainer.yml
